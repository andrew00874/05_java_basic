...
public class Korean {
     ...
     *  Korean k2 = new Korean(); // static 으로 작성된 nationalCode 는 다시 실행되지 않음
     */
    /* **************
     * 일반 초기화 블럭 : user가 접속할 때 마다 guest 부여할 때
     * k1, k2, k3 와 같은 유저마다 guest 칭호를 붙이고
     * k1 이 admin 이면 k1만 추후 admin 으로 교체
     * k2, k3 는 그대로 guest 칭호를 유지
     *
     ...
     *
     *     if 문이나 for switch while 문과 같이 특정 조건에서 다수 작성
     ***********************************************************
     *   기능이름 이 종료될 때 자료형이 일치하는 변수이름이나 데이터 값을 활용할 수 있도록 전달
    ...
    /************ int ************/
    public int method1(){
        // public 옆에 있는 자료형이 int 이기 때문에 return 옆에 숫자값이 들어가야함
        return 0;
    }

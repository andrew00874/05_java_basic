...
*                          필드 명칭 앞에 public static final 을 작성하지 않아도 묵시적으로 인식
*                          기능 또한
*                               void 메서드명칭();
...
* 컬렉션은 인터페이스 - 클래스 형태
*
* 컬렉션 프레임워크 : JAVA 개발자들이 자료구조를 만들어서
*                     JAVA를 사용하는 개발자들을 위하여 자료구조를 만들어서 모아둔것
*
...
*               Spring, React, Express(java가 아닌 JS로 백엔드를 개발하는 서버 관리)
*
* 라이브러리 : 개발자가 필요할 때 호출
...
*                    Integer, Boolean, Long, Character, Short, Byte, Double, Float
*                    위와 같은 객체 형태로 만들어 사용하기도 함
*
* 컬렉션의 대표적인 프레임워크로
* List 인터페이스가 존재
*       List를 기반으로 만들어진 ArrayList 객체를 주로 활용 매우 중요함
*
* */
